    ...
    return (
        <section>
            <div className="bg-primary pt-[150px] text-white relative z-10 overflow-hidden">
                ...
                {isLargeScreen &&
                    <>
                        <AutoScrollSlider direction="right" emblaWrapper="flex [margin-left:calc(4rem_*_-1)] items-center" wrapperCss="rotate-[5deg] absolute bottom-14 py-3 px-3 -ml-5 -mr-5 bg-secondary">
                            {
